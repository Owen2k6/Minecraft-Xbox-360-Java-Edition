...
public class ChunkProviderGenerate implements IChunkProvider {
	...
	public void populate(IChunkProvider var1, int var2, int var3) {
		...
		for(var17 = 0; var17 < var28; ++var17) {
			...
			(new WorldGenTallGrass(Block.field_9031_X.blockID, var26)).generate(this.worldObj, this.rand, var19, var20, var21);
		}
		...
		for(var17 = 0; var17 < var28; ++var17) {
			...
			(new WorldGenDeadBush(Block.field_9030_Y.blockID)).generate(this.worldObj, this.rand, var25, var19, var20);
		}
		...
		for(var25 = var4 + 8; var25 < var4 + 8 + 16; ++var25) {
			for(var19 = var5 + 8; var19 < var5 + 8 + 16; ++var19) {
				var20 = var25 - (var4 + 8);
				var21 = var19 - (var5 + 8);
				int var22 = this.worldObj.func_28100_e(var25, var19);
