...
public class McRegionChunkLoader implements IChunkLoader {
	...
	public void saveChunk(World var1, Chunk var2) throws IOException {
		...
		try {
			DataOutputStream var3 = RegionFileCache.func_22120_d(this.field_22110_a, var2.xPosition, var2.zPosition);
			...
			var6.setSizeOnDisk(var6.getSizeOnDisk() + (long)RegionFileCache.func_22121_b(this.field_22110_a, var2.xPosition, var2.zPosition));
