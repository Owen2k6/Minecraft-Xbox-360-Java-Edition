...
public class BlockLever extends Block {
	...
	public boolean func_28026_e(World var1, int var2, int var3, int var4, int var5) {
		return var5 == 1 && var1.isBlockOpaqueCube(var2, var3 - 1, var4) ? true : (var5 == 2 && var1.isBlockOpaqueCube(var2, var3, var4 + 1) ? true : (var5 == 3 && var1.isBlockOpaqueCube(var2, var3, var4 - 1) ? true : (var5 == 4 && var1.isBlockOpaqueCube(var2 + 1, var3, var4) ? true : var5 == 5 && var1.isBlockOpaqueCube(var2 - 1, var3, var4))));
	}
	...
	public void onNeighborBlockChange(World var1, int var2, int var3, int var4, int var5) {
		if(this.checkIfAttachedToBlock(var1, var2, var3, var4)) {
			...
			if(!var1.isBlockOpaqueCube(var2, var3 - 1, var4) && var6 == 6) {
				var7 = true;
			}
